...
-   Note: `GSE209552` is single nucleus RNA-seq (`snRNA-seq`).
...
Differ from RNA-seq and bulk RNA-seq normalization we covered in class, because scRNA-seq data is `zero-inflated`, most of gene's counts is `0` in most of cells.
